...
public class Controller  implements Initializable
{
            ...
            RunButton.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    try {
                        ...
                        if (MinimumNumber.getText().isBlank() || MinimumNumber.getText().isBlank()) {
    ...
    private void queryResult(Statement statement, String sqlQuery) throws SQLException {
        ResultSet solution = statement.executeQuery(sqlQuery);
        ObservableList<Numbers> RandomlyGeneratedNumbersDB = FXCollections.observableArrayList();
        while (solution.next()) {
            Numbers num = new Numbers();
            num.generateRandomNumbers = solution.getString("Generate Random Numbers");
